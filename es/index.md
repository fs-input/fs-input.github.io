...
layout: default
nav_order: 3
description: Método de entrada Fengshui forma-fonética — veloz como el viento, fluido como el agua
permalink: /es/
has_children: true
has_toc: false
---
...
# Método de entrada Fengshui forma-fonética
{: .fs-9 }

风水形音输入法
{: .fs-4 .text-grey-dk-000 }

— Veloz como <span class="fs-red">**el viento**</span>, fluido como <span class="fs-red">**el agua**</span>
{: .fs-5 }

`V 1.3.1` · Diccionario actualizado 2026.07.08
{: .text-grey-dk-000 }

---

![Tabla de radicales Fengshui](/assets/images/roots-table.png)
...
- Una tabla de radicales dispuesta según el Feng Shui
- Descomposición sencilla: ningún carácter es difícil de dividir
- Un diccionario amplio (157 000 palabras)
- Códigos de forma como base, códigos fonéticos como complemento
- Tres niveles de palabras candidatas, al alcance de los dedos
- Escritura precisa, dominio de todo el teclado
- Veloz como el viento, fluido como el agua
- La bendición del Feng Shui, la buena suerte a tu lado

## Por dónde empezar

- [Tabla de radicales](/es/01-roots) — la disposición de 26 teclas 米/人 de un vistazo
- [Lectura cultural](/es/02-culture) — Yin-Yang, los Cinco Elementos, pictografía alfabética y reglas mnemotécnicas
- [Descomposición de caracteres](/es/03-decomposition) — 174 ejemplos resueltos de descomposición
- [Tabla de descomposición](/es/decomposition-table) — consulta de 8 105 caracteres (con filtro en tiempo real)
- [Reglas de escritura](/es/04-rules) — reglas de codificación para caracteres individuales y palabras
- [Estadísticas de codificación](/es/05-statistics) — análisis de tasa de colisión y eficiencia
- [Instalación](/es/appendix-a-install) — Rime + el esquema Fengshui
- [Preguntas frecuentes](/es/appendix-b-qa) — comparación con Pinyin y Wubi
